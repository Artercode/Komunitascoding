            ...
            <div class="col-9 col-dm-9">
               <div class="tab-content" id="vert-tabs-right-tabContent">
                  ...
                  <div class="tab-pane fade show active" id="vert-tabs-right-1" role="tabpanel" aria-labelledby="vert-tabs-right-1-tab">
                     ...
                     <h5>5. Siapa yang mengelola session CI atau php sama saja, fungsi sama cuman cara coding aja yang berbeda, pada saat ini ditulis CI memiliki sedikit kelebihan.</h5>
                  </div>
                  <!-- cookies -->
