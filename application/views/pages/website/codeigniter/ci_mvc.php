         ...
         <div class="row">
            ...
            <div class="col-9 col-dm-9">
               <div class="tab-content" id="vert-tabs-right-tabContent">
                  ...
                  <!-- view -->
                  <div class="tab-pane fade" id="vert-tabs-right-view" role="tabpanel" aria-labelledby="vert-tabs-right-view-tab">
                     <section class="container col mt-n2">
                        <h5>1. Pakem</h5>
            ...
            <div class="col-3 col-dm-3">
               <div class="nav flex-column nav-tabs nav-tabs-right h-100" id="vert-tabs-right-tab" role="tablist" aria-orientation="vertical">
                  ...
                  <!-- controller -->
                  <a class="nav-link" id="vert-tabs-right-controller-tab" data-toggle="pill" href="#vert-tabs-right-controller" role="tab" aria-controls="vert-tabs-right-controller" aria-selected="false">Controller</a>
                  <!-- model -->
                  <a class="nav-link" id="vert-tabs-right-model-tab" data-toggle="pill" href="#vert-tabs-right-model" role="tab" aria-controls="vert-tabs-right-model" aria-selected="false">Model</a>
                  <!-- view -->
                  <a class="nav-link" id="vert-tabs-right-view-tab" data-toggle="pill" href="#vert-tabs-right-view" role="tab" aria-controls="vert-tabs-right-view" aria-selected="false">View</a>
               </div>
            </div>
         </div>
      </div>
